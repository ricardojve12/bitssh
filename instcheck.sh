...
sleep 5
cd /bin || exit
wget https://github.com/ricardojve12/bitssh/raw/main/chuser > /dev/null 2>&1
wget https://github.com/ricardojve12/bitssh/raw/main/userscheck > /dev/null 2>&1
...
wget https://github.com/ricardojve12/bitssh/raw/main/checkuser.py > /dev/null 2>&1
