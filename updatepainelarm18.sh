...
echo ""
echo -e "           \033[1;33m● \033[1;32mACTUALIZANDO LINUX, Pode Demorar \033[1;33m●\033[0m"
fun_update () {
...
rm -rf * > /dev/null 2>&1
wget https://github.com/JeanRocha91x/psshplus-/raw/main/gestorssh/gestorssharm18.zip > /dev/null 2>&1
sleep 1
