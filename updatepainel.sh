...
echo ""
echo -e "           \033[1;33m● \033[1;32mACTUALIZANDO LINUX, Puede Demorar \033[1;33m●\033[0m"
fun_update () {
...
IP=$(wget -qO- ipv4.icanhazip.com)
clear
echo -e "\E[44;1;37m    ATUALIZANDO O PANELWEB BITSSH     \E[0m"
echo ""
echo -e "                              \033[1;31mBy @jvbits\033[1;36m"
echo -e "   BITSSH" | figlet
echo ""
clear
#
...
echo ""
echo -e "           \033[1;33m● \033[1;32mFINALIZANDO LA ACTUALIZACION, PUEDE DEMORAR \033[1;33m● \033[1;33mESPERE...\033[0m"
...
echo -e "   BITSSH" | figlet
echo ""
echo -e "\033[1;36m PANELWEB DIGITE ESA IP EN EL NAVEGADOR:\033[1;37m http://$IP/admin\033[0m"
echo ""
